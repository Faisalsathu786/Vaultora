        ...
        <div className="hiw-body">
          ...
          <section className="hiw-section hiw-gradient">
            ...
            <div className="hiw-faq">
              ...
              <p><strong>Where does the exit tax go when I sell early?</strong> The exit tax stays within the market's liquidity pool and benefits the remaining token holders. When an early seller exits, a portion of their return is retained in the pool rather than being withdrawn. This increases the pool value for users who hold their positions to resolution, rewarding conviction and long-term participation. The tax rate starts at 30% for sells within the first day and decreases linearly to 0% after 7 days, encouraging patient holding strategies.</p>
